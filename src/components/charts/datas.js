          ...
          <div className="wrapper">
            <div className="sidebar">
              <ul>
                ...
                <Link to="chats1" style={{ textDecoration: "none" }}>
                  {" "}
                  <p id="menu3"> Academics Development</p>
                </Link>
                <Link to="chats2" style={{ textDecoration: "none" }}>
                  {" "}
                  <p id="menu3"> Emotional Development</p>
                </Link>
                <Link to="chats3" style={{ textDecoration: "none" }}>
                  {" "}
                  <p id="menu3"> Skill/Talent Development</p>
                </Link>
                <Link to="chats4" style={{ textDecoration: "none" }}>
                  {" "}
                  <p id="menu3">Physical Development</p>
                </Link>
                <Link to="chats5" style={{ textDecoration: "none" }}>
                  {" "}
                  <p id="menu3"> Achievement Development</p>
                </Link>
              </ul>
            </div>
          </div>
