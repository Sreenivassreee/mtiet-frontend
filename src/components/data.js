          ...
          <div className="wrapper">
            <div className="sidebar">
              <ul>
                ...
                <p id="menu3" onClick={() => setShow(!show)}>
                  {" "}
                  Academics Development
                </p>
                <p id="menu3" onClick={() => setShow2(!show2)}>
                  {" "}
                  Emotional Development
                </p>
                <p id="menu3" onClick={() => setShow3(!show3)}>
                  {" "}
                  Skill/Talent Development
                </p>
                <p id="menu3" onClick={() => setShow4(!show4)}>
                  Physical Development
                </p>
                <p id="menu3" onClick={() => setShow5(!show5)}>
                  {" "}
